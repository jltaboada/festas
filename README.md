...
- 🏷️ **Filtro por tipo** (música, espectáculo, deporte, infantil…): icono junto al buscador que abre un modal
  donde marcar varios tipos a la vez (con botón de limpiar). El icono muestra un contador de filtros activos.
...
- 📣 **Compartir la app** desde la portada (icono de compartir → Web Share API / copia al portapapeles).
